...
/// In-memory mock of the AppMachina SDK for unit tests.
///
...
public final class MockAppMachina: AppMachinaProtocol, @unchecked Sendable {
    ...
    /// Typed events recorded via `track(_ event: some AppMachinaEvent)`, preserving the original event type.
    public private(set) var typedTrackCalls: [any AppMachinaEvent] = []
    ...
    public func debugStatus() -> String {
        return "MockAppMachina(initialized: \(isInitialized), appUserId: \(appUserId ?? "nil"))"
    }
}
