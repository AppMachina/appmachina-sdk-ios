...
/// that can be passed to `AppMachina.track(_:)`.
///
...
/// Example:
/// ```swift
/// struct ButtonTapped: AppMachinaEvent {
///     let buttonId: String
///     var eventName: String { "button_tapped" }
///     var properties: [String: Any] { ["button_id": buttonId] }
/// }
/// AppMachina.track(ButtonTapped(buttonId: "cta_signup"))
/// ```
public protocol AppMachinaEvent {
...
/// ```swift
/// AppMachina.track(StandardEvent.purchase(amount: 9.99, currency: "USD", itemId: "sku_123"))
/// AppMachina.track(StandardEvent.viewItem(itemId: "sku_123", name: "Blue Widget"))
/// ```
public enum StandardEvent: String, AppMachinaEvent, Sendable {
...
public struct ParameterizedEvent: AppMachinaEvent, Sendable {
