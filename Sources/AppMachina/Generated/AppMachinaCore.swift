...
public struct UniFfiConfig {
    ...
    public init(appId: String, environment: AppMachinaEnvironment, baseUrl: String?, flushIntervalMs: UInt64?, flushThreshold: UInt32?, maxQueueSize: UInt32?, maxBatchSize: UInt32?, enableDebug: Bool?, sdkVersion: String?,
                /**
                    * Directory for file-based event persistence.
