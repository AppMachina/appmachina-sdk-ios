...
public final class DeepLinksModule: @unchecked Sendable {
    ...
    private static let log = OSLog(subsystem: "com.appmachina.sdk", category: "DeepLinksModule")
    ...
    public func handleDeepLink(_ url: URL) -> SafeResult<Void> {
        ...
        if let core = lockedCore {
            ...
            let json = AppMachina.jsonString(from: props)
            do {
                try core.track(
            ...
            if fbclid != nil || gclid != nil || ttclid != nil || msclkid != nil {
                AppMachina.shared.setAttributionData(
                    deeplinkId: AppMachina.shared.attributionDeeplinkId,
                    gclid: gclid ?? AppMachina.shared.attributionGclid,
                    fbclid: fbclid ?? AppMachina.shared.attributionFbclid,
                    ttclid: ttclid ?? AppMachina.shared.attributionTtclid,
                    msclkid: msclkid ?? AppMachina.shared.attributionMsclkid
                )
            }
        }
