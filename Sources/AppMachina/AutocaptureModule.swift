...
/// `AppMachinaConfig(automaticTouchAutocaptureEnabled: true)` because indiscriminate
...
public final class AutocaptureModule: @unchecked Sendable {
    ...
    private static let log = OSLog(subsystem: "com.appmachina.sdk", category: "autocapture")
    ...
    static func installSendEventSwizzleIfNeeded() {
        ...
        UIWindow.appmachina_installSendEventSwizzle()
...
extension UIWindow {
    ...
    @objc fileprivate static func appmachina_installSendEventSwizzle() {
        let originalSelector = #selector(UIWindow.sendEvent(_:))
        let swizzledSelector = #selector(UIWindow.appmachina_swizzled_sendEvent(_:))
    ...
    @objc fileprivate func appmachina_swizzled_sendEvent(_ event: UIEvent) {
        // After exchange, this calls the *original* sendEvent.
        appmachina_swizzled_sendEvent(event)
