...
/// Public surveys API exposed via `AppMachina.shared.surveys`.
@available(iOS 13.0, tvOS 13.0, macCatalyst 13.0, *)
public final class SurveysModule {
    private let coreProvider: () -> AppMachinaCoreHandle?
    ...
    init(coreProvider: @escaping () -> AppMachinaCoreHandle?) {
        self.coreProvider = coreProvider
    }

    private var core: AppMachinaCoreHandle? { coreProvider() }
