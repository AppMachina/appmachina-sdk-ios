...
///
/// Crash records persist to `<persistenceDir>/appmachina-pending-crash.json`.
...
/// via `AppMachinaConfig(automaticExceptionTrackingEnabled: false)`.
@available(iOS 14.0, macOS 12.0, tvOS 14.0, watchOS 7.0, *)
public final class ExceptionModule: @unchecked Sendable {

    // MARK: - Constants

    public static let pendingCrashFilename = "appmachina-pending-crash.json"
    ...
    private static let log = OSLog(subsystem: "com.appmachina.sdk", category: "exception")
    ...
    func attach(sdk: AppMachina, persistenceDir: String) {
        attach(
