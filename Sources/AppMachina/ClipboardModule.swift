...
/// Reads clipboard for AppMachina attribution URL on first launch.
...
public final class ClipboardModule: @unchecked Sendable {
    ...
    private static let log = OSLog(subsystem: "com.appmachina.sdk", category: "ClipboardModule")
    ...
    /// Check clipboard for a AppMachina attribution URL.
    ...
    public func checkClipboard() -> String? {
        ...
        if let url {
            ...
            os_log("No AppMachina attribution URL on clipboard", log: Self.log, type: .debug)
        }
    ...
    private static func readClipboard() -> String? {
        ...
        guard content.contains("in.appmachina.com/c/") || content.contains("link.appmachina.com/c/") else { return nil }
        return content
        #else
        return nil
        #endif
